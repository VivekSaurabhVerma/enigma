...
<head>
	...
	<meta name="description" content="Techfest, IIT Bombay Enigma, Overall Leaderboard">
...
<body>
    ...
    <div class="container" id="leaderboard-container">
        <div id="leaderboard-image-container">
            <img id="leaderboard-icon" src="{{asset('img/leaderboard-overall.png')}}" alt="Techfest Enigma overall leaderboard logo">
        </div>
    ...
    <a class="flow-button" href="{{ route('leaderboard')}}" id="overall-leaderboard">
